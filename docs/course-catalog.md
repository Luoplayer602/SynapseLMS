...
- Khi triển khai trình độ học viên/lớp/đăng ký, bắt buộc bổ sung kiểm tra các tham chiếu nghiệp vụ mới vào `require_unused` và test đồng thời; FK bảo vệ xóa là lớp cuối, không thay thế kiểm tra sử dụng khi đổi mã.
